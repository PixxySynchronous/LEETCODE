...
def build_stats_markdown():
    ...
    lines.append('    title Questions Solved by Category')
    ...
    lines.append(
        "<sub>Auto-generated by `scripts/generate_readme_stats.py` on every push — do not edit this section by hand.</sub>"
    )
